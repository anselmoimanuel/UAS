...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="img/Carousel-4.png" alt="Third slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/Carousel-5.png" alt="Third slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/Carousel-6.png" alt="Third slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/Carousel-7.png" alt="Third slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/Carousel-8.png" alt="Third slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/Carousel-9.png" alt="Third slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="img/Carousel-10.png" alt="Third slide">
            </div>
        </div>
