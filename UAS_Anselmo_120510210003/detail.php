            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 text-center">
                    <div class="main-menu-wrap">
                        ...
                        <div class="site-logo">
                            <a href="index.php">
                                <img src="img/logonontoncom.png" width="150" height="50">
                            </a>
                        </div>
                        <!-- logo -->
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 mt-5">
                    ...
                    <a href="watch.php?id=<?= $filmSearch['id'] ?>" class="btn btn-danger text-white p-3 px-5 my-5" style="border-radius:30px">Start Streaming</a><br>
                    <div class="detail text-light">
                    <p class="text-light">Genre : <?= $genreFilm[$filmSearch['genre']] ?></p><hr>
                    <p class="text-light">Release Date : <?= $filmSearch['release_date'] ?></p><hr>
                    <p class="text-light"> Vote Average : <?= $filmSearch['vote_average'] ?></p><hr>
                    <p class="text-light">Vote Count : <?= $filmSearch['vote_count'] ?></p><hr>
            ...
            <div class="row mt-5">
                <div class="col-sm-12 mb-4">
                    <h5>Similar to This Movie "<?= $filmSearch['title'] ?>"</h5>
                </div>
